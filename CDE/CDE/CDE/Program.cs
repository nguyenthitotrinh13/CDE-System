...
builder.Services.AddDbContext<ApplicationDbContext>(options => options.UseSqlServer(configuration.GetConnectionString("CDE_DB")));
...
builder.Services.AddAuthentication(options =>
{
    ...
    {
        options.Authority = $"https://login.microsoftonline.com/{configuration["AzureAd:bb823f62-b15b-40b6-b101-d3f090e6407c"]}";
